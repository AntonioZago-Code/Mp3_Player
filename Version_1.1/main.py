...
def main():
    ...
    while True:
        ...
        # IF DE USER ENTER THE 'R' OPTION, WILL PLAY A RANDOM SONG
        elif choice_input.upper() == "R":

            random_choice = int(os.urandom(1)[0]) % len(mp3_files) # RANDOM INDEX

            if 0 <= random_choice < len(mp3_files): play_music(folder, mp3_files[random_choice])
